...
const Footer = () => {
  return (
    <footer className="bg-[#070517] text-white pt-16 pb-5 px-16">
      <div className="max-w-[1400px] mx-auto flex flex-wrap justify-between">

        <div className="w-[50%]">
          <h2 className="text-3xl font-bold">CORSIT</h2>
        ...
        <div className="w-[18%]">
          ...
          <ul className="mt-4 space-y-4">
            ...
            <li>
              <a href="/projects" className="text-gray-400 hover:text-white text-xl">
                Workshop
              </a>
            </li>
            <li>
              <a href="/events" className="text-gray-400 hover:text-white text-xl">
                Robocor
              </a>
            </li>
          </ul>
        ...
        <div className="w-[30%]">
          ...
          <ul className="mt-4 space-y-4">
            <li className="flex items-center space-x-4 text-gray-400 text-xl">
      ...
      <p className="text-center text-gray-500 text-xl">&copy; 2025 CORSIT. All rights reserved.</p>
    </footer>
  );
};
