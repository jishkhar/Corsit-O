...
const Home = () => {
  return (
    <div className="relative text-[#f7ffff] flex flex-col overflow-x-hidden">
      ...
      {/* <div className="absolute top-0 left-0 w-full h-[200vh] z-0 pointer-events-none">
  ...
  {[
    ...
    >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              >
                <img src={project.image} className="w-full h-72 object-cover" />
                <div className="p-6">
      ...
      <div className="bg-[#191a1a] relative z-10 py-10 text-center text-white">
        Photo Gallery
      </div>
    </div>
  );
