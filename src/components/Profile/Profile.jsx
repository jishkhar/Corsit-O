  ...
  return (
    <>
      ...
      <div className="h-[100vh] bg-[#080514] text-white pt-40 px-52">
        <div className="flex h-fit items-start justify-start px-12 py-12 border border-[rgba(173,216,230,0.8)] rounded-2xl bg-[#0b001056]">
            ...
            <div>
              <div className="w-[40vw] mx-auto my-12 p-12 rounded-3xl shadow-2xl text-xl">
                <div className="mb-8 flex items-center gap-6">
                  ...
                  <p className="text-gray-300 text-3xl">Jishnu Khargharia</p>
                </div>

                <div className="mb-8 flex items-center gap-6">
                  <h2 className="text-4xl font-bold text-white">Email:</h2>
                  <p className="text-gray-300 text-3xl">jiskhar011@gmail.com</p>
                </div>

                <div className="mb-8 flex items-center gap-6">
                  <h2 className="text-4xl font-bold text-white">Designation:</h2>
